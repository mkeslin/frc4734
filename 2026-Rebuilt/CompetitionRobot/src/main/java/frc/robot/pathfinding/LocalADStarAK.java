...
/**
 * PathPlanner pathfinder that works with AdvantageKit log replay.
 * Pathfinding runs live on the robot; during replay, pathfinder state is read from the log.
 *
 * @see <a href="https://pathplanner.dev/pplib-pathfinding.html">PathPlanner Pathfinding</a>
 * @see <a href="https://gist.github.com/mjansen4857/a8024b55eb427184dbd10ae8923bd57d">LocalADStarAK gist</a>
 */
    ...
    private static class ADStarIO implements LoggableInputs {
        ...
        public void fromLog(LogTable table) {
            ...
            for (int i = 0; i < pointsLogged.length; i += 2) {
                pathPoints.add(new PathPoint(new Translation2d(pointsLogged[i], pointsLogged[i + 1])));
            }
        ...
        void updateCurrentPathPoints(PathConstraints constraints, GoalEndState goalEndState) {
