...
public final class AutoConstants {
    ...
    /** Final nudge (m) toward the bar (-X) and +Y right before retract. */
    public static final double CLIMB_DRIVE_BEFORE_RETRACT_X_METERS = 0.0762;  // 3 in
    public static final double CLIMB_DRIVE_BEFORE_RETRACT_Y_METERS = 0.1016;  // 4 in
