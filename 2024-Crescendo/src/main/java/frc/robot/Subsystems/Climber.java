...
public class Climber extends SubsystemBase {
    ...
    private double RETRACT_ENCODER_VAL = -16; //Actual Stowed Value: -13.2
    private double EXTEND_ENCODER_VAL = 61; //Actual Deploy Value: 66.5
    ...
    public Climber() {
        m_climber_left = new TalonFX(CLIMBER_LEFT_ID);
        ...
        m_climber_right = new TalonFX(CLIMBER_RIGHT_ID);
