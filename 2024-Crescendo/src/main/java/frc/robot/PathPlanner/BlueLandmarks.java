...
public class BlueLandmarks {
    ...
    public static final Pose2d Start2 = getPose(1.41, 5.5, 0);
    public static final Pose2d Start1 = getPose(.75, 4.39, 300);

    public static final Pose2d Amp = getPose(1.8, 7.5, 90.0);
    public static final Pose2d Speaker = getPose(1.41, 5.5, 0);
    ...
    public static final Pose2d Note3 = getPose(2.07, 7.0, 0.0);
    public static final Pose2d Note2 = getPose(2.07, 5.55, 0.0);
