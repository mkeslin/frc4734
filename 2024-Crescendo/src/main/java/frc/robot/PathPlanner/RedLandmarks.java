...
public class RedLandmarks {
    ...
    public static final Pose2d Start3 = getPose(15.8, 6.7, 120);
    public static final Pose2d Start2 = getPose(15.16, 5.5, 180);
    public static final Pose2d Start1 = getPose(15.8, 4.39, 240);

    public static final Pose2d Amp = getPose(14.8, 7.5, 90.0);
    public static final Pose2d Speaker = getPose(15.16, 5.5, 180);
    ...
    public static final Pose2d Note3 = getPose(14.5, 7.0, 180.0);
    public static final Pose2d Note2 = getPose(14.5, 5.55, 180.0);
