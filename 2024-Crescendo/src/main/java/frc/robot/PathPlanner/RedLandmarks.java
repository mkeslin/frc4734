...
public class RedLandmarks {
    ...
    public static final Pose2d Note1 = getPose(14.3, 7.0, 60.0);
    public static final Pose2d Note2 = getPose(14.3, 5.5, 60.0);
    public static final Pose2d Note3 = getPose(14.3, 4.0, 60.0);

    public static final Pose2d Note4 = getPose(8.9, 7.4, 60.0);
    public static final Pose2d Note5 = getPose(8.9, 5.7, 60.0);
    public static final Pose2d Note6 = getPose(8.9, 4.0, 60.0);
    public static final Pose2d Note7 = getPose(8.9, 2.4, 60.0);
    public static final Pose2d Note8 = getPose(8.9, 0.8, 60.0);
