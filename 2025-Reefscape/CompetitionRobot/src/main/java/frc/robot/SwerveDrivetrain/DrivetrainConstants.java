...
public class DrivetrainConstants {
    ...
    public static final double MaxSpeed = 3.5; // meters per second desired top speed
    // public static final double MaxSpeed = SwerveDrivetrainA.kSpeedAt12Volts.in(MetersPerSecond) * .77569420; // kSpeedAt12Volts desired top speed
