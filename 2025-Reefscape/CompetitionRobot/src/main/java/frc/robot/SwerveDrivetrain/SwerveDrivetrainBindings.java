    ...
    public static void configureBindings(CommandXboxController driveController, CommandSwerveDrivetrain drivetrain) {
        ...
        drivetrain.setDefaultCommand(
                drivetrain.applyRequest(() -> m_drive
                        .withVelocityX(coordinateOrientation * driveController.getLeftY() * CurrentSpeed) // Drive forward
                                                                                                      // with negative Y
                                                                                                      // (forward)
                        .withVelocityY(coordinateOrientation * driveController.getLeftX() * CurrentSpeed) // Drive left with
                                                                                                      // negative X
                                                                                                      // (left)
