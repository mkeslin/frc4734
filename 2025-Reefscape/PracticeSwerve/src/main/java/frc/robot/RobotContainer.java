...
public class RobotContainer {
    ...
    // private final CommandXboxController m_mechanismController = new
    // CommandXboxController(ControllerIds.XC2ID);
    ...
    public void configureArcadeBindings() {
        ...
        m_arcadeController.axisLessThan(ControllerButtons.CLY, -0.5)
                .onTrue(Commands.sequence(shootNoteCommand, m_shooter.commandSetAngle(1)));
        m_arcadeController
                .axisGreaterThan(ControllerButtons.CLY, 0.5)
                .onTrue(intakeNoteCommand);

        m_arcadeController.axisLessThan(ControllerButtons.CRY, -0.5)
                .onTrue(m_shooter.commandSetAngle(Shooter.TELEOP_SPEAKER_PIVOT_ENCODER_VAL));
