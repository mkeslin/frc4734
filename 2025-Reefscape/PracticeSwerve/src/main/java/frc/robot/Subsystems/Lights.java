...
import static frc.robot.Constants.Constants.LIGHTS_0_ID;
...
public class Lights extends SubsystemBase {
    ...
    private final CANdle m_candle = new CANdle(LIGHTS_0_ID);
    ...
    public Lights() {
        ...
        // m_candle.animate(new TwinkleAnimation(30, 70, 60, 0, 0.4, LedCount,
